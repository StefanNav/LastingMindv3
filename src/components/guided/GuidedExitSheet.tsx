...
interface GuidedExitSheetProps {
  isOpen: boolean
  onSaveAndExit: () => void
  onKeepGoing: () => void
}

export function GuidedExitSheet({ isOpen, onSaveAndExit, onKeepGoing }: GuidedExitSheetProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            ...
            <p className="mt-2 text-[14px] leading-[1.5] text-muted-foreground">
              Everything you've shared so far is saved. You can pick up where you left off.
            </p>
