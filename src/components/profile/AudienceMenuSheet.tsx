...
import { X, UserPen, Bell, KeyRound, ShieldCheck, HelpCircle, LogOut, Users } from 'lucide-react'

interface AudienceMenuSheetProps {
  isOpen: boolean
  onClose: () => void
...
export function AudienceMenuSheet({ isOpen, onClose, onManageCreators }: AudienceMenuSheetProps) {
  ...
  const menuItems = [
    {
      icon: Users,
      label: 'Manage Legacy Creators',
      action: () => {
        onClose()
        onManageCreators()
      },
    },
    { icon: UserPen, label: 'Edit profile', action: onClose },
    { icon: Bell, label: 'Notification preferences', action: onClose },
    { icon: KeyRound, label: 'Account details', action: onClose },
    { icon: ShieldCheck, label: 'Privacy & data', action: onClose },
    { icon: HelpCircle, label: 'Help & support', action: onClose },
    { icon: LogOut, label: 'Sign out', action: onClose },
  ]
