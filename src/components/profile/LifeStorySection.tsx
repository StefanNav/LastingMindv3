    ...
    <div className="flex flex-col gap-3">
      {chapters.map((ch) => (
        <button
          ...
          className="flex items-center justify-between rounded-[10px] bg-lm-bg-card/40 px-5 py-4 shadow-card backdrop-blur-sm transition-transform active:scale-[0.98]"
        >
