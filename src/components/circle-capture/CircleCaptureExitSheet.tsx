...
interface CircleCaptureExitSheetProps {
  isOpen: boolean
  onLeave: () => void
  onKeepGoing: () => void
}

export function CircleCaptureExitSheet({ isOpen, onLeave, onKeepGoing }: CircleCaptureExitSheetProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            ...
            <p className="mt-2 text-[14px] leading-[1.5] text-muted-foreground">
              Your names won't be saved if you leave now.
            </p>
